...
This notebook performs the Lloyd's algorithm in the Campbell2D case with the true Campbell maps.
...
```{r, results='hide'}
lloyd_res_true = lloyd_campbell(gamma, maps_true, densite_vec)
...
```{r}
for(i in 1:5){print(plot_map(lloyd_res_true$gamma[[i]]))}
```
